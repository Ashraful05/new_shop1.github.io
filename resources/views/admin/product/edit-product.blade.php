    ...
    <div class="col-md-11">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="text-center text-success">Product Category Form</h4>
            </div>
            <div class="panel-body">
                ...
                <!-- <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                        <textarea cols="form-control" name="short_description">{{$product->short_description}}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                        <textarea cols="form-control" name="long_description" id="editor" >{{$product->long_description}}</textarea>
