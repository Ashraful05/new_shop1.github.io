...
<body>
    ...
    <script src="{{asset('/')}}/admin/js/jquery-1.3.2.min.js"></script>
    <script src="{{asset('/')}}/admin/js/example.js"></script>

    <!-- Custom Theme JavaScript -->
    <script src="{{ asset('/') }}admin/dist/js/sb-admin-2.js"></script>
    <script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js" data-cf-settings="32d302d63190cc9182bf87a6-|49" defer=""></script>
    <script type="text/javascript" id="xyz">
